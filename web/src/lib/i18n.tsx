...
const DICT: Dict = {
  ...
  abhaOptional: { en: "ABHA Number (optional)", hi: "आभा नंबर (वैकल्पिक)" },
  fetchRecords: { en: "Fetch Records", hi: "रिकॉर्ड प्राप्त करें" },
  abhaVerifiedVia: { en: "ABHA verified via ABDM", hi: "ABDM के माध्यम से आभा सत्यापित" },
  linkedRecords: { en: "Linked health records", hi: "लिंक किए गए स्वास्थ्य रिकॉर्ड" },
  autoFilled: { en: "Hospital record auto-filled from ABHA-linked records.", hi: "आभा-लिंक्ड रिकॉर्ड से अस्पताल रिकॉर्ड स्वतः भर गया।" },
  schemeLabel: { en: "Funding scheme", hi: "वित्त योजना" },
  schemePmjay: { en: "PM-JAY / Ayushman Bharat Claim", hi: "पीएम-जय / आयुष्मान भारत दावा" },
  schemePmjayHint: {
    en: "Government scheme — cashless treatment, ₹5 lakh family cover, pre-authorisation mandatory.",
    hi: "सरकारी योजना — कैशलेस उपचार, ₹5 लाख परिवार कवर, पूर्व-अनुमोदन अनिवार्य।",
  },
  privacyTitle: { en: "Privacy by design", hi: "डिज़ाइन से ही गोपनीयता" },
  privacyNote: {
    en: "Your ABHA and full health records stay OFF-CHAIN. Only a tamper-proof keccak256 commitment of the decision is written to Monad — no sensitive data ever leaves your side.",
    hi: "आपका आभा और पूर्ण स्वास्थ्य रिकॉर्ड ऑफ-चेन रहते हैं। केवल निर्णय का छेड़छाड़-रहित keccak256 हैश मोनाड पर दर्ज होता है — कोई संवेदनशील डेटा कभी बाहर नहीं जाता।",
  },
  offChainData: { en: "Off-chain (private)", hi: "ऑफ-चेन (निजी)" },
  onChainData: { en: "On-chain (Monad)", hi: "ऑन-चेन (मोनाड)" },
